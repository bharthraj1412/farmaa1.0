...
from middleware import sanitize_string, sanitize_search_query, require_role
...
@router.post("", response_model=CropOut, status_code=201, dependencies=[Depends(require_role("farmer", "admin"))])
@router.post("/", response_model=CropOut, status_code=201, include_in_schema=False, dependencies=[Depends(require_role("farmer", "admin"))])
...
@router.put("/{crop_id}", response_model=CropOut, dependencies=[Depends(require_role("farmer", "admin"))])
...
@router.delete("/{crop_id}", status_code=204, dependencies=[Depends(require_role("farmer", "admin"))])
